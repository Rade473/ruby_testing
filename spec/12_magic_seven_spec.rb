...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the prebious step is 8' do
      it 'returns 4' do
      previous_step = 8
  ...
  describe '#subtract_random_number' do
    random_number = MagicSeven.new(4)
    it 'subtracts random number' do
    result = random_number.subtract_random_number(4)
  ...
  describe '#play' do
    context 'when the random number is 4' do
      ...
      it 'will return 7' do
        random_number = MagicSeven.new(4)
        expect(random_number.play).to eq(7)
      end
    end
    ...
    context 'when the random number is 10' do
      # remove the 'x' before running this test
      it 'will return 7' do
        random_number = MagicSeven.new(10)
        expect(random_number.play).to eq(7)
      end
    end
    ...
    context 'when the random number is 19' do
      # remove the 'x' before running this test
      it 'will return 7' do
        random_number = MagicSeven.new(19)
        expect(random_number.play).to eq(7)
      end
    end
  end
